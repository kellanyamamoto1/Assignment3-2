...
class TestOpenFile(unittest.TestCase):
    ...
    def test_open_file_as_administrator(self, mock_commands, mock_file_name, mock_get_path, mock_open):
    ...
    @patch('file_module.file_name')
    @patch('file_module.commands')
    def test_open_file_as_non_administrator(self, mock_commands, mock_file_name, mock_get_path, mock_open):
